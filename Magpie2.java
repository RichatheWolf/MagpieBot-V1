...
public class Magpie2
{
    ...
    public String getResponse(String statement)
    {
                ...
                || statement.indexOf("brother") >= 0)
        {
            ...
            response = "Tell me more about your friends, what are they like?";
        }
        else if (statement.indexOf("school") >= 0 || statement.indexOf("class") >= 0){
            response = "Which class is your favorite?";
        }
        else if (statement.indexOf("work") >= 0){
            response = "How was your job? Where do you work?";
        }
        else
        {
    ...
    private String getRandomResponse()
    {
        ...
        {
            response = "That's good to know. How are you doing?";
        }
